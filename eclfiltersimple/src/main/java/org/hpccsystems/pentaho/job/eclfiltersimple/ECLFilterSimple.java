 ...
 * @author ShetyeD
 */
public class ECLFilterSimple extends ECLJobEntry{//extends JobEntryBase implements Cloneable, JobEntryInterface {
	...
	*/
    ...
    public Result execute(Result prevResult, int k) throws KettleException {
        ...
        sb.append("FilterSimple").append(" := ").append(this.inRecordName).append("(");
        if(this.filterStatement.isEmpty()){
       ...
       if(persist.equalsIgnoreCase("true")){
    		if(outputName != null && !(outputName.trim().equals(""))){
    			ecl += "OUTPUT(FilterSimple "+",,'~"+outputName+"::filtersimple', __compressed__, overwrite,NAMED('FilterSimple'))"+";\n";
    		}else{
    			ecl += "OUTPUT(FilterSimple "+",,'~"+jobName+"::filtersimple', __compressed__, overwrite,NAMED('FilterSimple'))"+";\n";
    		}
    	}
    	else{
    		ecl += "OUTPUT(FilterSimple ,NAMED('FilterSimple'));\n";
    	}
