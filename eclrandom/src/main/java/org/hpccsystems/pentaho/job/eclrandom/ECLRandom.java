        ...
        if(result.isStopped()){
            ...
            if(persist.equalsIgnoreCase("true")){
        		if(outputName != null && !(outputName.trim().equals(""))){
        			project += "OUTPUT("+this.getDatasetName()+"_with_random"+",,'~eda::random::"+outputName+"', __compressed__, overwrite,NAMED('Random'))"+";\n";
        		}else{
        			project += "OUTPUT("+this.getDatasetName()+"_with_random"+",,'~eda::random::"+defJobName+"_"+"', __compressed__, overwrite,NAMED('Random'))"+";\n";
        		}
        	}
        	else{
