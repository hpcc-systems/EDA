 ...
 * @author KeshavS
 */
public class ECLRegressionDialog extends ECLJobEntryDialog{//extends JobEntryDialog implements JobEntryDialogInterface {
	
	public static final String NAME = "Name";
	public static final String DEP = "Dependance";
	public static final String INDEX = "Index";
	public static final String[] PROP = { NAME, DEP, INDEX };
    private ECLRegression jobEntry;
    ...
    public JobEntryInterface open() {
        ...
        Method = buildCombo("Method:", datasetName, lsMod, middle, margin, fieldsGroup, new String[]{"Sparse","Dense"});
        Rsquared = buildCombo("Rsquared : ", Method, lsMod, middle, margin, fieldsGroup,new String[]{"YES","NO"});
        Anova = buildCombo("Anova : ", Rsquared, lsMod, middle, margin, fieldsGroup,new String[]{"YES","NO"});	
        Rsquared.setText("NO");
        Anova.setText("NO");
	    ...
	    Method.addModifyListener(new ModifyListener() {
			
			@Override
			public void modifyText(ModifyEvent arg0) {
				if(Method.getText().equalsIgnoreCase("Dense")){
					Anova.setEnabled(false);
					Anova.setText("NO");
				}
				else{
					Anova.setEnabled(true);
					Anova.setText("");
				}
			}
		});
        ...
        if (jobEntry.getRsquared() != null) {
        	Rsquared.setText(jobEntry.getRsquared());
        }
        
        if (jobEntry.getAnova() != null) {
            Anova.setText(jobEntry.getAnova());
        }
    ...
    private boolean validate(){
    	...
    	if(depends == 0 || depends > 1){
    		isValid = false;
    		errors += "Select One Dependant Variable!\r\n";
    	}
    	
    	if(this.Method.getText().equals("")){
    		isValid = false;
    		errors += "\"Method Type\" is a required field!\r\n";
    	}
    ...
    private void ok() {
        ...
        jobEntry.setRsquared(Rsquared.getText());
        jobEntry.setAnova(Anova.getText());
        jobEntry.setFields(fields);
        jobEntry.setMethod(Method.getText());
...
class PersonCellModifier implements ICellModifier {
	  ...
	  public Object getValue(Object element, String property) {
	    ...
	    if (ECLRegressionDialog.NAME.equals(property))
	      return p.getFirstName();
	    if (ECLRegressionDialog.DEP.equals(property))
		      return p.getDependance();
	    if (ECLRegressionDialog.INDEX.equals(property))
		      return p.getIndex();
	    else
	      return null;
	  }
	  ...
	  public void modify(Object element, String property, Object value) {
	    ...
	    else if (ECLRegressionDialog.DEP.equals(property))
